...
def run_train(args: typing.Optional[argparse.Namespace] = None, env=None) -> None:
    ...
    #training.array_train(**train_args)


def gene_train(args: typing.Optional[argparse.Namespace] = None, env=None) -> None:
    if env is not None:
        os.environ = env
    ...
    training.gene_train(**train_args)
...
def gene_predict(args: typing.Optional[argparse.Namespace] = None, env=None) -> None:
    if env is not None:
        os.environ = env
    ...
    training.gene_predict(**train_args)
...
def gene_train_distributed(args: typing.Optional[argparse.Namespace] = None) -> None:
    ...
    utils.launch_process_group(
           gene_train, args, args.nproc_per_node, args.nnodes,
...
def gene_predict_distributed(args: typing.Optional[argparse.Namespace] = None) -> None:
    """Runs distributed training via multiprocessing.
    """
    if args is None:
        base_parser = create_base_parser()
    ...
    utils.launch_process_group(
           gene_predict, args, args.nproc_per_node, args.nnodes,
           args.node_rank, args.master_addr, args.master_port)
...
if __name__ == '__main__':
    ...
    #gene_predict()
    #gene_train()
    #gene_train_distributed()
    #gene_predict_distributed()
